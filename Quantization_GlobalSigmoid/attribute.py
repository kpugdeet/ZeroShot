...
class attribute (object):
    def __init__(self):
        ...
        with tf.control_dependencies(updateOps):
            # self.trainStep = tf.train.AdamOptimizer(globalV.FLAGS.lr).minimize(self.totalLoss, var_list=tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope='attribute'))
