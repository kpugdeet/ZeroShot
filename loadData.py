    ...
    def getData():
        if os.path.isfile(globalV.FLAGS.BASEDIR + globalV.FLAGS.KEY + '/backup/trainClass.pkl'):
            ...
            if globalV.FLAGS.KEY == 'SUN' or globalV.FLAGS.KEY == 'APY':
                trainYAtt = np.load(globalV.FLAGS.BASEDIR + globalV.FLAGS.KEY + '/backup/trainYAtt.pkl.npy')
                valYAtt = np.load(globalV.FLAGS.BASEDIR + globalV.FLAGS.KEY + '/backup/valYAtt.pkl.npy')
                testYAtt = np.load(globalV.FLAGS.BASEDIR + globalV.FLAGS.KEY + '/backup/testYAtt.pkl.npy')
            else:
            ...
            if globalV.FLAGS.KEY == 'SUN' or globalV.FLAGS.KEY == 'APY':
                np.save(globalV.FLAGS.BASEDIR + globalV.FLAGS.KEY + '/backup/trainYAtt.pkl', trainYAtt)
                np.save(globalV.FLAGS.BASEDIR + globalV.FLAGS.KEY + '/backup/valYAtt.pkl', valYAtt)
                np.save(globalV.FLAGS.BASEDIR + globalV.FLAGS.KEY + '/backup/testYAtt.pkl', testYAtt)
